...
(function(){
  ...
  var event2interval;
    ...
    function changeImage(e,idx) {
        ...
        e.src = "/upload/modelView/MODEL_CamryWildHybrid/main/tnga3"+x+"/"+lpad(idx,5)+".png";
    }
    ...
    var vr = function (el) {
        ...
        function render() {
            img.src = '/upload/modelView/MODEL_CamryWildHybrid/main/vr/'+model+'_'+light+'/'+lpad(step,5)+".png";
            var xpos = pos.m;
            var t0,t1;
            t1 = '';
        ...
        function preload(size,cb) {
            ...
            for (var i = 0 ; i < size ; ++i) {
                ...
                cache[i].src = '/upload/modelView/MODEL_CamryWildHybrid/main/vr/'+model+'_'+light+'/'+lpad(i,5)+".png";
            }
            if (!cb) return;
    ...
    (function page2preload() {
        ...
        for (var i = 0 ; i < 33 ; ++i) {
            var img = new Image();
            img.src = '/upload/modelView/MODEL_CamryWildHybrid/main/tnga3'+x+'/'+lpad(i,5)+".png";
        }
    })();
    ...
    (function(){
        ...
        render();
        disp.src = "/upload/modelView/MODEL_CamryWildHybrid/main/gallery/"+ (window.innerWidth < 960 ? 'm/' : '')+"3.jpg";

        items.click(function(){
            var da = [3,5,7,8,10,11,13,14,15,16,17];
            var dx = da[this.className.substr(1)*1-1];
            disp.src = "/upload/modelView/MODEL_CamryWildHybrid/main/gallery/"+ (window.innerWidth < 960 ? 'm/' : '')+dx+".jpg";
