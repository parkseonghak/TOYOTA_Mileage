$(document).ready(function () {
  ...
  /* ----------------------------------------------------------------------- 주요 2 : ia 정보구조 생성 */
  ajaxcallingJSON("/resources/json/IA.json?v=1", "GET", '', function (data) {
    iaData = data.ia;
    if (depth1 === 1000) {
      mainPage.settings();
    } else if (depth1 === 1001) {
  ...
  function globalActions() {
    ...
    $('.drive_testInner').find('.close').on('click', function (e) {
      ...
      currentStep1 = false;
      currentStep2 = false;
      $('.clip > div.clip_img').find('img').attr('src', '/upload/modelView/test_carDum_empty.jpg');
      commonjs.eventClick(e);
    });
    //시승신청 닫기 버튼
  ...
  function checkDataNewsletter() {
    ...
    }).html('<img src="/upload/modelView/loading.gif" style="width:64px;height:64px;margin-top:-32px;margin-left:-32px;position:absolute;left:50%;top:50%;">');
    ...
    cardMake: function (jsonURL, target) {
      ...
      function addElement() {
        ...
        if (_data.dataList[i].sns_channel == "facebook") {
          var iconImg = '/upload/modelView/only_main_storyIcon4.jpg';
          var linkTarget = 'target = "_blank"';
        } else if (_data.dataList[i].sns_channel == "youtube") {
          var iconImg = '/upload/modelView/only_main_storyIcon2.jpg';
          var linkTarget = 'target = "_blank"';
        } else if (_data.dataList[i].sns_channel == "instagram") {
          var iconImg = '/upload/modelView/only_main_storyIcon3.jpg';
          var linkTarget = 'target = "_blank"';
        } else if (_data.dataList[i].sns_channel == "naverblog") {
          var iconImg = '/upload/modelView/only_main_storyIcon1.jpg';
          var linkTarget = 'target = "_blank"';
        } else if (_data.dataList[i].sns_channel == "toyota") {
          var iconImg = '/upload/modelView/only_main_storyIcon6.jpg';
  ...
  var models = {
    modelTemp: function (MName) {
      ...
      function keyvisualFnc(data) {
        ...
        $.each(_data, function (index) {
          ...
          if($('.model_text').hasClass('model_camry')){
            $('<li class="model' + (index + 1) + '"></li>').appendTo($('#model').find('ul')).html('<div class="' + addClassY + ' ' + addClassX + '"><div class="dlt"><h4>' + _data[index].title + '</h4><p>' + _data[index].comment + '</p><s onclick="$(this.parentNode.parentNode).addClass(\'show-detail\')">내용보기 ></s></div><span class="dim"><img src="/upload/modelView/hybridcommon/mobile_text_toggle_x.png" class="toggle-x" onclick="$(this).parent().parent().removeClass(\'show-detail\')"></span></div>').addClass(_data[index].textColorClass).height($('.sub_visualModel').height());
          } else {
      ...
      function Mkslider(data) {
        ...
        // 20190514 RAV4HV 추가 시작
		if ($('#convenience').length) {
			$('<div class="slide_wrap"></div>').appendTo($('#convenience')).viSlider({
			  stru: _data[3].convenience[0].tabmenu,
			  subtitle: true,
			  arrow: false,
			  tabmenu: false,
			  rszImgRepl: true,
			  cut: _data[3].convenience[0].cut == undefined ? 70 : _data[3].convenience[0].cut,
			});
		}
	    // 20190515 RAV4HV 추가 끝

		if($(document).find('#performance').length > 0) {
          $('<div class="slide_wrap"></div>').appendTo($('#performance')).viSlider({
            stru: _data[3].performance[0].tabmenu,
            subtitle: true,
            arrow: false,
            tabmenu: false,
            rszImgRepl: true,
            cut: _data[3].performance[0].cut == undefined ? 70 : _data[3].performance[0].cut,
          });
        }
  ...
  var subPage = {
      ...
      function loadContents() {
        ...
        $.each(_data.dataList, function (index) {
          if (index < 3 && currentPageNum == 1) {
            $('<li></li>').appendTo($recent).html('<div class="recent_inner"><span><img src="/upload/modelView/new_icon.png" alt=""></span><div class="recent_img"><a href="' + _data.dataList[index].link + '"><img src="' + _data.dataList[index].thumbnail_img + '" alt=""></a></div><a href="' + _data.dataList[index].link + '"><h5 class="' + _data.dataList[index].title_lan + '">' + _data.dataList[index].title + '</a></h5><p><a href="' + _data.dataList[index].link + '">' + _data.dataList[index].comment + '</a></p><span class="more"><a href="' + _data.dataList[index].link + '">MORE</a></span></div>');
          }
    ...
    mkCard: function () {
      ...
      if (depth3 == 0) {
        ...
        $('.more_btn').show();
        $selectResult.find('>li').html('<a href="#none">' + selectText.event[0] + '<img src="/upload/modelView/check_boxIcon.png" alt=""></a>');

      } else if (depth3 == 5) {
        //갤러리
        jsonUrl = url_inside_gallery;
        $('.more_btn').show();
        $selectResult.find('>li').html('<a href="#none">' + selectText.gallery[0] + '<img src="/upload/modelView/check_boxIcon.png" alt=""></a>');
      } else if (depth3 == 4) {
        //스토리
        jsonUrl = url_inside_story
        $('.more_btn').show();
        $selectResult.find('>li').html('<a href="#none">' + selectText.story[0] + '<img src="/upload/modelView/check_boxIcon.png" alt=""></a>');
      } else if (depth3 == 6) {
      ...
      function addElement() {
        ...
        if (depth3 == 0) {
          ...
          if (_data.dataList[i].sns_channel == "facebook") {
            var iconImg = '/upload/modelView/main_storyIcon4.jpg';
            var linkTarget = 'target = "_blank"';
          } else if (_data.dataList[i].sns_channel == "youtube") {
            var iconImg = '/upload/modelView/main_storyIcon2.jpg';
            var linkTarget = 'target = "_blank"';
          } else if (_data.dataList[i].sns_channel == "instagram") {
            var iconImg = '/upload/modelView/main_storyIcon3.jpg';
            var linkTarget = 'target = "_blank"';
          } else if (_data.dataList[i].sns_channel == "naverblog") {
            var iconImg = '/upload/modelView/main_storyIcon1.jpg';
            var linkTarget = 'target = "_blank"';
          } else if (_data.dataList[i].sns_channel == "toyota") {
            var iconImg = '/upload/modelView/main_storyIcon6.jpg';
      ...
      function selectDate() {
        ...
        $check_box.find('div.check_boxPopup').each(function (index) {
          ...
          _year = loopArray[0];
          $check_box.find('>ul>li').html('<a href="#none">' + _year + '<img src="/upload/modelView/check_boxIcon.png" alt=""></a>');
          for (var i = 0; i < loopArray.length; i++) {
            $('<li></li>').appendTo(_this.find('>ul')).html(loopArray[i]).on('click', function (e) {
              ...
              _year = resultValue;
              $check_box.find('>ul>li').html('<a href="#none">' + resultValue + '<img src="/upload/modelView/check_boxIcon.png" alt=""></a>');
        ...
        if (sval.length > 0) $check_box.find('>ul>li').html('<a href="#none">' + sval + '<img src="/upload/modelView/check_boxIcon.png" alt=""></a>');
      }
        ...
        $checkBox.find('li').each(function (index) {
          ...
          _thisLi.on('click', function (e) {
            ...
            if (depth3 == 0) {
              ...
              $('.check_box').find('>ul>li').html('<a href="#none">' + returnText[index + 1] + '<img src="/upload/modelView/check_boxIcon.png" alt=""></a>')
            } else {
              $('.check_box').find('>ul>li').html('<a href="#none">' + returnText[index] + '<img src="/upload/modelView/check_boxIcon.png" alt=""></a>')
              if (index == 0) {
                params = {};
              } else {
      ...
      function filtersBtn() {
        ...
        $checkBox.find('li').each(function (index) {
          ...
          _thisLi.on('click', function (e) {
            ...
            $selectResult.find('>li').html('<a href="#none">' + printText + '<img src="/upload/modelView/check_boxIcon.png" alt=""></a>');
            //                        _thisLi.addClass('check_on');
            if (index == 0) {
              //필터중 '전체'
              target.empty();
    ...
    hybridSet: function () {
      ...
      function qnaSet(num) {
        ...
        for (var i = 0; i < _data.length; i++) {
          ...
          _target.find('>ul').find('>li').eq(i).find('>p').html('<span><img src="/upload/modelView/a_img.png" alt=""></span>' + _data[i].a);
        }
        //for
        ...
        _moreBtn.on('click', function (e) {
          if (!allOpen) {
            ...
            _moreBtn.html('전체 답변 닫기 <span><img src="/upload/modelView/arrow_up.png" alt=""></span>');
            allOpen = true;
          } else {
            _target.find('>ul').find('>li').removeClass('active');
            _moreBtn.html('전체 답변 열기 <span><img src="/upload/modelView/arrow_down.png" alt=""></span>');
            allOpen = false;
          }
          commonjs.eventClick(e);
        });
    ...
    mkDealersSet4: function () {
      ...
      function lnbSet() {
        ...
        $('.lnb_title > h3').html('전시장<img src="/upload/modelView/down_arrow.png" alt="">');
        ...
        $('.lnb_title').find('> ul > li').each(function (index) {
          ...
          _this.on('click', function (e) {
            ...
            if (currentStep1 !== index) {
              ...
              $('.lnb_title > h3').html(titleName[index] + '<img src="/upload/modelView/down_arrow.png" alt="">');
              $('.check_box').find('>.check_box').find('>ul').find('>li').html('<a href="#none">전국 <img src="/upload/modelView/check_boxIcon.png" alt=""></a>');
        ...
        $top_m_3depth.find('.check_boxPopup').find('> ul > li').each(function (index) {
          ...
          $this.on('click', function (e) {
            ...
            $top_m_3depth.find('>ul').find('>li').html('<a href="#none">' + $this.find('>a').text() + ' <img src="/upload/modelView/check_boxIcon.png" alt=""></a>');
            commonjs.eventClick(e);
          });
        });
      ...
      function returnAddhtml(Num) {
        ...
        if (currentStep1 == 0) {
          //딜러사
          Addhtml = '<li><a href="' + _printdata[Num][1][0].website + '"><span><img src="/upload/modelView/dealers_icon1.jpg" alt="" class="wt100"></span>딜러페이지</a></li>';
        } else {
          //서비스 센터
          if (_printdata[Num][1][0].coating == "yes") {
            Addhtml2 = '<span><img src="/upload/modelView/dealers_icon3.png" alt=""> 판금/도장</span>';
          }
        }
      ...
      function mkstep1() {
        $dealersStep1.find('>li').each(function (index) {
          ...
          $this.on('click', function (e) {
            ...
            $top_m_3depth.find('>ul > li > a').html($top_m_3depth.find('>.check_boxPopup').find('li[area1=' + $this.attr("area1") + '] > a').text() + '  <img src="/upload/modelView/check_boxIcon.png" alt=""></a>');
            commonjs.eventClick(e);
          });
          //광역시도 클릭
        });
      ...
      function mkstep3() {
        $('.step_common.step3').find('.stc_st3List').find('>ul').find('>li').each(function (index) {
          var _this = $(this);
          _this.on('click', function (e) {
            $('.lnb_title').find('>h3').html(titleName[index] + '<img src="/upload/modelView/down_arrow.png" alt="">');
        ...
        if (sv == 1) {
          //'서비스센터'로 다이렉트 접속
          $('.lnb_title').find('>h3').html(titleName[sv] + '<img src="/upload/modelView/down_arrow.png" alt="">');
    ...
    mkDealersPage: function () {
      ...
      function mkMenu() {
        ...
        trg.find('>li').each(function (index) {
          ...
          _thisLi.on('click', function (e) {
            ...
            openContents(index);
            $lnb_title.find('>h3').html(_thisLi.find('>a').text() + '<img src="/upload/modelView/down_arrow.png" alt="">');
            //딜러사 수정을 위한 코드
            _thisLi.addClass('current').siblings().removeClass('current');
            commonjs.eventClick(e);
          });
      ...
      function mkDealersMain() {
        ...
        $lnb_title.find('>h3').html(_data.sub[0].title + '<img src="/upload/modelView/down_arrow.png" alt="">');
        //lnb안에 딜러사 이름
                ...
                if (d_code == 24) {
                  for (var i = 0; i < newArr.length; i++) {
                    ...
                    if (newArr[i].image.length > 0) {
                      ...
                      var imgEmbed = '/upload/modelView/dl_contants2.jpg';
                    }
                    ...
                    mainImg[i].onerror = function (i) {
                      _thisLi.find('>ul.dealersSlide').find('>li').eq(i).html('<img src="/upload/modelView/dl_contants2.jpg" alt="">');
                    };
                  ...
                  for (var i = 0; i < newArr.length; i++) {
                    ...
                    mainImg[i].onerror = function (i) {
                      _thisLi.find('>ul.dealersSlide').find('>li').eq(i).html('<a href="#" ' + targeting + '><img src="/upload/modelView/dl_contants2.jpg" alt=""></a>');
                    };
                    mainImg[i].src = imgEmbed;
                  }
                }
      ...
      function dealersEventSlide(ele, data) {
        ...
        function mkIndicate() {
          ...
          for (var i = 0; i < maxSD + 1; i++) {
            $('<a href="#"></a>').appendTo(_target).html('<img src="/upload/modelView/hybridcommon/slide_indicate_normal.png">').on('click', function (e) {
        ...
        //----------------- mkArrow - 화살표 만들기
        function mkArrow() {
          $('<a href="#" class="arrowBtn prev"></a>').appendTo(ele).html('<img src="/upload/modelView/hybridcommon/Btn_arrow_left.png">').on('click', function (e) {
            if (currentSD > 0) {
              currentSD--;
            } else {
              currentSD = maxSD;
          ...
          $('<a href="#" class="arrowBtn next"></a>').appendTo(ele).html('<img src="/upload/modelView/hybridcommon/Btn_arrow_right.png">').on('click', function (e) {
            if (currentSD < maxSD) {
              currentSD++;
            } else {
              currentSD = 0;
        ...
        function motionSD(num) {
          ...
          ele.find('.indicate').find('>a').each(function (index) {
            var _this = $(this);
            if (index !== num) {
              _this.html('<img src="/upload/modelView/hybridcommon/slide_indicate_normal.png">')
            } else {
              _this.html('<img src="/upload/modelView/hybridcommon/slide_indicate_active.png">')
            }
          });
        }
    ...
    lnbCtrl: function () {
      ...
      if (window.__sectionName) {
        ...
        if (depth1 == 1 && depth2 == 10) {
          _sectionName = [$('#model'), $('#exterior'), $('#interior'), $('#features'), $('#gallery'), $('#colors'), $('#specs')];
        }
        if (depth2 == 13) {
        ...
        // 20190523 RAV4
        if (depth2 == 6) {
          _sectionName = [$('#model'), $('#exterior'), $('#interior'), $('#features'), $('#convenience'), $('#accessory'),$('#specs'), $('#footer')];
        }

		// 210602 RAV4 HEV
        if (depth2 == 5) {
          _sectionName = [$('#model'), $('#exterior'), $('#interior'), $('#features'),$('#convenience'), $('#accessory'), $('#gallery'), $('#specs'), $('#footer')];
        }

		// 20191016 GRSUPRA 추가
		if (depth2 == 16) {
          _sectionName = [$('#model'), $('#performance'), $('#exterior'), $('#interior'), $('#features'), $('#safety'), $('#colors'), $('#specs'), $('#footer')];
        }
		// 210420 SIENNA_HYBRID
		if (depth2 == 20) {
          _sectionName = [$('#model'), $('#exterior'), $('#interior'),$('#convenience'), $('#safety'),$('#accessories'),$('#films'), $('#specs'), $('#footer')];
        }
		// 2100525 CAMRYGASOLINE_22YEAR
		if (depth2 == 21) {
          _sectionName = [$('#model'), $('#exterior'), $('#interior'), $('#features'), $('#safetysense'), $('#specs'), $('#footer')];
        }
		// 2100525 CAMRYWILDHYBRID_22YEAR
		if (depth2 == 22) {
          _sectionName = [$('#model'), $('#exterior'), $('#interior'), $('#safety'), $('#features'), $('#gallery'), $('#colors'), $('#specs'), $('#footer')];
        }
        // 20220418 진경수 (RAV4 HYBRID)
        if (depth2 == 23) {
          _sectionName = [$('#model'), $('#exterior'), $('#interior'), $('#safety'), $('#performance'), $('#convenience'), $('#colors'), $('#gallery'), $('#specs')];
        }
        
        // 20220526 진경수 (GR86 수정)
        if(depth2 == 24) {
          _sectionName = [$('#model'), $('#heritage'), $('#highlights'), $('#performance'), $('#exterior'), $('#interior'), $('#features'), $('#safety'), $('#colors'), $('#films'), $('#specs')];
        }
        
        // 20220611 진경수 (PRIUS 추가, 공홈에는 없음)
        if(depth2 == 3) {
            _sectionName = [$('#prius'), $('#exterior'), $('#interior'), $('#features'), $('#gallery'), $('#colors'), $('#specs')];
        }
      ...
      if ((depth1 == 0 && depth2 == 0) || depth1 == 1 || depth1 == 2) {
        ...
        if (depth1 == 1) {
          ...
          $('.lnb_wrap').find('.lnb_title').find('ul > li').each(function (index) {
            ...
            if(iaData[depth1][1][depth2][1][index] != undefined) {
          ...
          if (iaData[depth1][1][depth2][0].pdf !== undefined && iaData[depth1][1][depth2][0].pdf != "") {
            //$('<li class="havPdf"><a href="#" id="downloadpdf" onclick="ga(\'send\', \'event\', \'Click\', \'E-CATALOGUE 다운로드 : ' + iaData[depth1][1][depth2][1][0].d3name + ' \');">E-CATALOGUE</a></li>').appendTo($('.lnb_wrap').find('.lnb_title').find('ul'));
        	  var downURL = 'www.toyotakoreaapp.co.kr/upload/manual/' + iaData[depth1][1][depth2][0].pdf + '';
              // 20220525 진경수 (E-CATALOGUE 삭제)
        	  /*$('<li class="havPdf"><a href="uniwebview://message?action=2&amp;link='+downURL+'" id="" onclick="ga(\'send\', \'event\', \'Click\', \'E-CATALOGUE 다운로드 : ' + iaData[depth1][1][depth2][1][0].d3name + ' \');">E-CATALOGUE</a></li>').appendTo($('.lnb_wrap').find('.lnb_title').find('ul'));*/
...
//            });
        ...
        $lnb_title.find('ul').find('li').each(function (index) {
            console.log("lnb_title ul li each "+ index);
      ...
      console.log("===> lnbCtrl _sectionName", _sectionName);
    },
  ...
  $quickToggle.on('click', function (e) {
	  //console.log('in',$(this).hasClass('active'));
