...
;(function($, exports, undefined){
    ...
    //if
    $.fn.viSliderPrius = function(option){
        var _this = $(this),
...
//                            slidefunc.slideMotion(current);
            ...
            mk2depth : function(num){
                ...
                for(var i = 0; i < setVal.stru[num].subcategory.length; i++){
                    $('<li></li>').appendTo(_this.find('.viSlider-indicate')).html('<a href="#" class="thumbnail" ><img src="/upload/modelView/MODEL_New_PRIUS/img_v0514/thumbnail_dummy.png" class="dummy"><img src="' + setVal.stru[num].subcategory[i].thumbnail + '"></a><div class="title">' + setVal.stru[num].subcategory[i].title + '</div>')
                    .find('a').on('click',function(e){
...
//                                subtitle = '<div class="slide_ect"><h3>' + setVal.stru[num].subcategory[i].subtitle + '</h3></div>';
                                ...
                                subtitle = '<div class="slide_ect" style="z-index : 10"><div class="slide_ectTitle"><h4>' + setVal.stru[num].subcategory[i].subtitle + '</h4><div class="ect_check"><span class="first">내용보기<span><img src="/upload/modelView/hybridcommon/arrow_up.png" alt=""></span></span><span class="second">내용접기<span><img src="/upload/modelView/hybridcommon/arrow_down.png" alt=""></span></span></div></div><div class="slide_ectText">' + descVal + '</div></div>';
                        }
