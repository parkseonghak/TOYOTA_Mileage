...
//                            slidefunc.slideMotion(current);
            ...
            mk2depth : function(num){
                ...
                for(var i = 0; i < setVal.stru[num].subcategory.length; i++){
                    $('<li></li>').appendTo(_this.find('.viSlider-indicate')).html('<a href="#" class="thumbnail" ><img src="/upload/modelView/MODEL_AvalonHybrid/thumbnail_dummy.png" class="dummy"><img src="' + setVal.stru[num].subcategory[i].thumbnail + '"></a><div class="title">' + setVal.stru[num].subcategory[i].title + '</div>')
                    .find('a').on('click',function(e){
