...
//        player.stopVideo();
        if($(this).data('movie') == 'none'){
            ...
            if(idx == 2){
                ...
                $('.player_wrap > a img').attr('src','/upload/modelView/m_prius/image/main_popVisual3.jpg');
            } else {
                $('.player_wrap > a').attr('href','#none');
                $('.player_wrap > a img').attr('src','/upload/modelView/m_prius/image/main_popVisual2.jpg');
            }
        } else {
            $('#ytplayer').show();
            $('.player_wrap > a').hide();
...
//                    $('.secButton').show(300);
    ...
    function ct2_view(idx){
        $('.ct2_viewImg').attr('src','/upload/modelView/m_prius/image/'+ct2Arr[idx]+'.jpg');
    ...
    $('.car_colorBtn ul li').click(function(){
        ...
        $('.carImg img').attr('src','/upload/modelView/m_prius/image/'+arr.colors[idx].car);
...
//            $('.gal_movie iframe').remove();
            ...
            $('.gal_viewInner > a > img').attr('src','/upload/modelView/m_prius/image/'+gal_arr.img[idx].name+'.jpg');
