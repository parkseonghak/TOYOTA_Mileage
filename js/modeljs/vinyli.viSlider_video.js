...
//                       _this.find('div.indicate').find('a').eq(thiscurrent).click();
            ...
            mkIndicate : function(e){
                ...
                for(var i = 0; i < maxSlide; i++){
                    $('<a href="#"></a>').appendTo(_this.find('div.indicate')).html('<img src="/upload/modelView/hybridcommon/slide_indicate_normal.png"/>')
                    .on('click',function(e){
                    ...
                    _this.find('div.indicate').find('>a').eq(thiscurrent).find('img').attr('src','/upload/modelView/hybridcommon/slide_indicate_active.png');
                }
                //for
            },
...
//                console.log(insertImg);
        ...
        var makeDepth = {
            mkArrow : function(e){
                $('<a href="#"></a>').appendTo(_this).addClass('arrowBtn prev').html('<img src="/upload/modelView/hybridcommon/mainSlide/Btn_arrow_left.png">');
                $('<a href="#"></a>').appendTo(_this).addClass('arrowBtn next').html('<img src="/upload/modelView/hybridcommon/mainSlide/Btn_arrow_right.png">');
...
//                console.log(thiscurrent);
                _this.find('div.indicate').find('>a').find('img').attr('src','/upload/modelView/hybridcommon/slide_indicate_normal.png')
                _this.find('div.indicate').find('>a').eq(thiscurrent).find('img').attr('src','/upload/modelView/hybridcommon/slide_indicate_active.png');
