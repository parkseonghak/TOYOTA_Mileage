...
//                       _this.find('div.indicate').find('a').eq(thiscurrent).click();
        ...
        var makeDepth = {
            mkArrow : function(e){
                $('<a href="#"></a>').appendTo(_this).addClass('arrowBtn prev').html('<img src="/upload/modelView/hybridcommon/Btn_arrow_left.png">');
                $('<a href="#"></a>').appendTo(_this).addClass('arrowBtn next').html('<img src="/upload/modelView/hybridcommon/Btn_arrow_right.png">');
